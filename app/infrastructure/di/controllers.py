...
from app.infrastructure.di.usecases import get_create_user_use_case, get_speed_test_use_case, \
    ...
    get_update_speed_test_servers_use_case
...
async def get_walk_test_controller(
        ...
        update_speed_test_server_use_case : UpdateSpeedTestServersUseCase = Depends(get_update_speed_test_servers_use_case)
) -> WalkTestController:
...
async def get_speed_test_servers_controller(update_speed_test_server_use_case: UpdateSpeedTestServersUseCase = Depends(get_update_speed_test_servers_use_case)) -> SpeedTestServerController:
