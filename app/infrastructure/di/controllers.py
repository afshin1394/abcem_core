...
from app.infrastructure.di.usecases import get_create_user_use_case, get_speed_test_use_case, get_walk_test_use_case
...
async def get_walk_test_controller(create_walk_test_use_case : CreateWalkTestUseCase = Depends(get_walk_test_use_case)) -> WalkTestController:
