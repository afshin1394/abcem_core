...
from sqlalchemy import Column,String,TIMESTAMP,Enum,Boolean
...
class WalkTestTable(BaseDBModel):
    ...
    refId = Column(String, unique=True)
    province = Column(String, nullable=True)
    region = Column(String, nullable=True)
    city = Column(String, nullable=True)
    is_village = Column(Boolean, nullable=False)
    ...
    technology = Column(Enum(TechnologyEnum,name="technology_enum"), nullable=False)
