...
from app.domain.services.get_gis_service import AreAllLocationsWithinDistanceService


class AreAllLocationsWithinDistanceServiceImpl(AreAllLocationsWithinDistanceService):
...
#    print(asyncio.run( AreAllLocationsWithinDistanceServiceImpl().validate_location_within_offset(
#         offset=50,
